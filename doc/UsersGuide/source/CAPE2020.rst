...
.. note:: 
   ...
   In order to generate all necessary configuration, data, input, and fix files to run in this method, the user first needs to run the base RT script using ``./ufs_test.sh -n`` to set up the run directory. 
